...
$can_add = ACL::is_allowed("body_berita/add");
$can_edit = ACL::is_allowed("body_berita/edit");
$can_view = ACL::is_allowed("body_berita/view");
$can_delete = ACL::is_allowed("body_berita/delete");
?>
<?php
        ...
        <div class="container-fluid">
            <div class="row ">
                <div class="col-md-12 comp-grid">
                    <?php if($can_add){ ?>
                    <a  class="btn btn btn-primary my-1" href="<?php print_link("body_berita/add") ?>">
                        ...
                        <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                            <ul class="breadcrumb m-0 p-1">
                                ...
                                <li class="breadcrumb-item">
                                    <a class="text-decoration-none" href="<?php print_link('body_berita'); ?>">
                    ...
                    <div  class=" animated fadeIn page-content">
                        <div id="body_berita-list-records">
                            <?php
                            if(!empty($records)){
                            ?>
                                ...
                                <div class="row justify-content-center page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    ...
                                    <div class="col-sm-3">
										...
										<div class="row">
												...
												<div class="" data-loop="true" data-items="1" data-margin="30" data-autoplay="false" data-autoplay-timeout="5000" data-smart-speed="1200" data-dots="true" data-nav="true" data-nav-speed="false" data-mobile-device="1" data-mobile-device-nav="true" data-mobile-device-dots="true" data-ipad-device="1" data-ipad-device-nav="true" data-ipad-device-dots="true" data-md-device="1" data-md-device-nav="true" data-md-device-dots="true">
													<div class="event-item">
														...
														<div class="events-details white-bg">
															...
															<h4 class="event-title"><a href="events-details.html"><?php echo $data['judul_berita']; ?></a></h4>
															<div class="event-meta">
															 
																<div class="event-location">
																	<i class="fa fa-map-marker"></i>
																	<span><?php echo $data['isi_berita']; ?></span>
																</div>
															</div>
															<div class="event-btn">
                                            ...
                                            <div class="td-btn">
                                                <?php if($can_view){ ?>
                                                <a class="btn btn-sm btn-success has-tooltip" title="View Record" href="<?php print_link("body_berita/view/$rec_id"); ?>">
                                                    <i class="fa fa-eye"></i> View
                                                </a>
                                                <?php } ?>
                                                <?php if($can_edit){ ?>
                                                <a class="btn btn-sm btn-info has-tooltip" title="Edit This Record" href="<?php print_link("body_berita/edit/$rec_id"); ?>">
