            ...
            <div class="row ">
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-vertical needs-validation" action="<?php print_link("laporan/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                        ...
                                        <div class="form-group col-sm-4">
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div id="ctrl-keterangan_laporan-holder" class=""> 
                                                    <textarea placeholder="Enter Keterangan Laporan" id="ctrl-keterangan_laporan"  rows="5" name="keterangan_laporan" class="htmleditor form-control"><?php  echo $data['keterangan_laporan']; ?></textarea>
                                                    <!--<div class="invalid-feedback animated bounceIn text-center">Please enter text</div>-->
                                                </div>
                                            </div>
                                            <div class="form-group ">
                                            ...
                                            <div class="form-group ">
                                                <label class="control-label" for="catatan_laporan2">Catatan Laporan2 </label>
                                                <div id="ctrl-catatan_laporan2-holder" class=""> 
                                                    <textarea placeholder="Enter Catatan Laporan2" id="ctrl-catatan_laporan2"  rows="5" name="catatan_laporan2" class="htmleditor form-control"><?php  echo $data['catatan_laporan2']; ?></textarea>
                                                    <!--<div class="invalid-feedback animated bounceIn text-center">Please enter text</div>-->
                                                </div>
                                            </div>
                                        </div>
