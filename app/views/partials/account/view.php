        ...
        <div class="container">
            <div class="row ">
                <div class="col-md-12 comp-grid">
                    <a  class="btn btn-primary" href="<?php print_link("login/list") ?>">
                        Admin 
                    </a>
                                        ...
                                        <div class="tab-pane show active fade" id="AccountPageView" role="tabpanel">
                                            <table class="table table-hover table-borderless table-striped">
                                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                                    ...
                                                    <tr  class="td-upload_photo">
                                                        <th class="title"> Upload Photo: </th>
                                                        <td class="value">
                                                            <span <?php if($can_edit){ ?> data-pk="<?php echo $data['id'] ?>" 
                                                                data-url="<?php print_link("login/editfield/" . urlencode($data['id'])); ?>" 
                                                                data-name="upload_photo" 
                                                                data-title="Enter Upload Photo" 
                                                                data-placement="left" 
                                                                data-toggle="click" 
                                                                data-type="textarea" 
                                                                data-mode="popover" 
