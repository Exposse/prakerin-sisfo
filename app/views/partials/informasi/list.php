...
$can_add = ACL::is_allowed("informasi/add");
$can_edit = ACL::is_allowed("informasi/edit");
$can_view = ACL::is_allowed("informasi/view");
$can_delete = ACL::is_allowed("informasi/delete");
?>
<?php
    ...
    <div  class="my-5">
        <div class="container-fluid">
            <div class="row ">
                ...
                <div class="col-sm-4 ">
                    <form  class="search" action="<?php print_link('informasi'); ?>" method="get">
            ...
            <div class="container-fluid">
                <div class="row ">
                    <div class="col-md-12 comp-grid">
                        <?php if($can_add){ ?>
                        <a  class="btn btn btn-primary my-1" href="<?php print_link("informasi/add") ?>">
                            ...
                            <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                                <ul class="breadcrumb m-0 p-1">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a class="text-decoration-none" href="<?php print_link('informasi'); ?>">
                                    ...
                                    <div class="row justify-content-center page-data" id="page-data-<?php echo $page_element_id; ?>">
										...
										<div class="row">
											<div class="col-md-12">
                                                ...
                                                <div class="td-btn">
                                                    <?php if($can_view){ ?>
                                                    <a class="btn btn-sm btn-success has-tooltip" title="View Record" href="<?php print_link("informasi/view/$rec_id"); ?>">
                                                        <i class="fa fa-eye"></i> View
                                                    </a>
                                                    <?php } ?>
                                                    <?php if($can_edit){ ?>
                                                    <a class="btn btn-sm btn-info has-tooltip" title="Edit This Record" href="<?php print_link("informasi/edit/$rec_id"); ?>">
