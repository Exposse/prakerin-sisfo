                            ...
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    ...
                                    <tr  class="td-photo">
                                        ...
                                        <td class="value"> <?php echo $data['upload_photo']; ?> </td>
                                    </tr>
                                    <tr  class="td-nama">
                                    ...
                                    <tr  class="td-pasword">
                                        <th class="title"> Pasword: </th>
                                        <td class="value">
                                            <span <?php if($can_edit){ ?> data-value="<?php echo $data['pasword']; ?>" 
                                                data-pk="<?php echo $data['id'] ?>" 
                                                data-url="<?php print_link("login/editfield/" . urlencode($data['id'])); ?>" 
                                                data-name="pasword" 
                                                data-title="Enter Pasword" 
                                                data-placement="left" 
                                                data-toggle="click" 
                                                data-type="password" 
                                                data-mode="popover" 
                                    ...
                                    <tr  class="td-role">
                                        ...
                                        <td class="value">
                                            <span <?php if($can_edit){ ?> data-source='<?php print_link('api/json/login_role_option_list'); ?>' 
