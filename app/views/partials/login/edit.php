            ...
            <div class="row ">
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-vertical needs-validation" action="<?php print_link("login/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                <div class="form-group ">
                                    ...
                                    <div id="ctrl-upload_photo-holder" class=""> 
                                        <textarea placeholder="Enter Upload Photo" id="ctrl-upload_photo"  required="" rows="5" name="upload_photo" class="htmleditor form-control"><?php  echo $data['upload_photo']; ?></textarea>
