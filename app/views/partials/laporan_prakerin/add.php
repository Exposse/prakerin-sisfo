            ...
            <div class="row ">
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form id="laporan_prakerin-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-vertical needs-validation" action="<?php print_link("laporan_prakerin/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                        ...
                                        <div class="form-group col-sm-4">
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div id="ctrl-keterangan_laporan-holder" class=""> 
                                                    <textarea placeholder="Enter Keterangan Laporan" id="ctrl-keterangan_laporan"  rows="3" name="keterangan_laporan" class="htmleditor form-control"><?php  echo $this->set_field_value('keterangan_laporan',""); ?></textarea>
                                                    <!--<div class="invalid-feedback animated bounceIn text-center">Please enter text</div>-->
                                                </div>
                                            </div>
                                            <div class="form-group ">
                                                ...
                                                <div id="ctrl-catatan_laporan1-holder" class=""> 
                                                    <textarea placeholder="Enter Catatan Laporan1" id="ctrl-catatan_laporan1"  rows="5" name="catatan_laporan1" class="htmleditor form-control"><?php  echo $this->set_field_value('catatan_laporan1',""); ?></textarea>
                                                    <!--<div class="invalid-feedback animated bounceIn text-center">Please enter text</div>-->
                                                </div>
                                            </div>
                                            <div class="form-group ">
                                                ...
                                                <div id="ctrl-catatn_laporan2-holder" class=""> 
                                                    <textarea placeholder="Enter Catatn Laporan2" id="ctrl-catatn_laporan2"  rows="5" name="catatn_laporan2" class="htmleditor form-control"><?php  echo $this->set_field_value('catatn_laporan2',""); ?></textarea>
                                                    <!--<div class="invalid-feedback animated bounceIn text-center">Please enter text</div>-->
                                                </div>
                                            </div>
                                            <div class="form-group ">
                                                ...
                                                <div id="ctrl-catatan_laporan3-holder" class=""> 
                                                    <textarea placeholder="Enter Catatan Laporan3" id="ctrl-catatan_laporan3"  rows="5" name="catatan_laporan3" class="htmleditor form-control"><?php  echo $this->set_field_value('catatan_laporan3',""); ?></textarea>
                                                    <!--<div class="invalid-feedback animated bounceIn text-center">Please enter text</div>-->
                                                </div>
                                            </div>
                                        </div>
