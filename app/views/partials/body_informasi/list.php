...
$can_add = ACL::is_allowed("body_informasi/add");
$can_edit = ACL::is_allowed("body_informasi/edit");
$can_view = ACL::is_allowed("body_informasi/view");
$can_delete = ACL::is_allowed("body_informasi/delete");
?>
<?php
        ...
        <div class="container-fluid">
            <div class="row ">
                <div class="col-md-12 comp-grid">
                    <?php if($can_add){ ?>
                    <a  class="btn btn btn-primary my-5" href="<?php print_link("body_informasi/add") ?>">
                        ...
                        <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                            <ul class="breadcrumb m-0 p-1">
                                ...
                                <li class="breadcrumb-item">
                                    <a class="text-decoration-none" href="<?php print_link('body_informasi'); ?>">
                    ...
                    <div  class=" animated fadeIn page-content">
                        <div id="body_informasi-list-records">
                            <?php
                            if(!empty($records)){
                            ?>
                                    ...
                                    <div class="bg-light p-2 mb-3">
                                      <div class="container">
										...
										<div class="row">
                                            ...
                                            <div class="td-btn">
                                                <?php if($can_view){ ?>
                                                <a class="btn btn-sm btn-success has-tooltip" title="View Record" href="<?php print_link("body_informasi/view/$rec_id"); ?>">
                                                    <i class="fa fa-eye"></i> View
                                                </a>
                                                <?php } ?>
                                                <?php if($can_edit){ ?>
                                                <a class="btn btn-sm btn-info has-tooltip" title="Edit This Record" href="<?php print_link("body_informasi/edit/$rec_id"); ?>">
