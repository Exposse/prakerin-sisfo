            ...
            <div class="row ">
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-vertical needs-validation" action="<?php print_link("pengumuman/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                <div class="form-group ">
                                    <label class="control-label" for="nama_pengumuman">Nama Pengumuman </label>
                                    <div id="ctrl-nama_pengumuman-holder" class=""> 
                                        <textarea placeholder="Enter Nama Pengumuman" id="ctrl-nama_pengumuman"  rows="5" name="nama_pengumuman" class="htmleditor form-control"><?php  echo $data['nama_pengumuman']; ?></textarea>
