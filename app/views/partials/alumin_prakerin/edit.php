            ...
            <div class="row ">
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-vertical needs-validation" action="<?php print_link("alumin_prakerin/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                ...
                                <div class="row">
                                    <div class="form-group col-sm-4">
                                        ...
                                        <div id="ctrl-nam_lengkap-holder" class=""> 
                                            <input id="ctrl-nam_lengkap"  value="<?php  echo $data['nam_lengkap']; ?>" type="text" placeholder="Enter Nam Lengkap"  name="nam_lengkap"  class="form-control " />
                                            </div>
                                        </div>
                                        <div class="form-group col-sm-4">
                                            <label class="control-label" for="asal_sekolah">Asal Sekolah </label>
                                            <div id="ctrl-asal_sekolah-holder" class=""> 
                                                <input id="ctrl-asal_sekolah"  value="<?php  echo $data['asal_sekolah']; ?>" type="text" placeholder="Enter Asal Sekolah"  name="asal_sekolah"  class="form-control " />
                                                </div>
                                            </div>
                                            <div class="form-group col-sm-4">
                                                <label class="control-label" for="jurusan">Jurusan </label>
                                                <div id="ctrl-jurusan-holder" class=""> 
                                                    <input id="ctrl-jurusan"  value="<?php  echo $data['jurusan']; ?>" type="text" placeholder="Enter Jurusan"  name="jurusan"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group ">
