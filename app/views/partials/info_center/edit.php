            ...
            <div class="row ">
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-vertical needs-validation" action="<?php print_link("info_center/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                <div class="form-group ">
                                    <label class="control-label" for="upload_logo">Upload Logo </label>
                                    <div id="ctrl-upload_logo-holder" class=""> 
                                        <textarea placeholder="Enter Upload Logo" id="ctrl-upload_logo"  rows="5" name="upload_logo" class="htmleditor form-control"><?php  echo $data['upload_logo']; ?></textarea>
